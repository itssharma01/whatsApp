...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!binding.etStatus.getText().toString().equals("") && !binding.txtUserName.getText().toString().equals("")) {
                    ...
                    database.getReference().child(FirebaseAuth.getInstance().getUid())
                            .updateChildren(obj);
        ...
        binding.txtView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(SettingsActivity.this, "Sab kuch janna hai iss badwe ko", Toast.LENGTH_LONG).show();
